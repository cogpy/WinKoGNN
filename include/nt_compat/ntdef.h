...
/* ================================================================== */
/* KSM Iteration 6 — Forward declarations for remaining C2081 types   */
/* ================================================================== */

/* --- SID_NAME_USE / PSID_NAME_USE (154 C2081 hits) --- */
...
/* --- FINDEX_SEARCH_OPS (104 C2081 hits) --- */
#ifndef _FINDEX_SEARCH_OPS_DEFINED
#define _FINDEX_SEARCH_OPS_DEFINED
...
/* --- KNORMAL_ROUTINE / PKNORMAL_ROUTINE (75 C2081 hits) --- */
...
/* --- IMAGE_RESOURCE_DIRECTORY_ENTRY / PIMAGE_RESOURCE_DIRECTORY_ENTRY (57 C2081) --- */
#ifndef _IMAGE_RESOURCE_DIRECTORY_ENTRY_DEFINED
#define _IMAGE_RESOURCE_DIRECTORY_ENTRY_DEFINED
struct _IMAGE_RESOURCE_DIRECTORY_ENTRY;
typedef struct _IMAGE_RESOURCE_DIRECTORY_ENTRY IMAGE_RESOURCE_DIRECTORY_ENTRY, *PIMAGE_RESOURCE_DIRECTORY_ENTRY;
#endif

/* --- IMAGE_RESOURCE_DATA_ENTRY / PIMAGE_RESOURCE_DATA_ENTRY (31 C2081) --- */
#ifndef _IMAGE_RESOURCE_DATA_ENTRY_DEFINED
#define _IMAGE_RESOURCE_DATA_ENTRY_DEFINED
struct _IMAGE_RESOURCE_DATA_ENTRY;
typedef struct _IMAGE_RESOURCE_DATA_ENTRY IMAGE_RESOURCE_DATA_ENTRY, *PIMAGE_RESOURCE_DATA_ENTRY;
#endif

/* --- LPOVERLAPPED_COMPLETION_ROUTINE (50 C2081) --- */
...
typedef VOID (*LPOVERLAPPED_COMPLETION_ROUTINE)(
    ...
    IN ULONG dwNumberOfBytesTransfered,
    IN PVOID lpOverlapped
);
#endif

/* --- IO_STACK_LOCATION / PIO_STACK_LOCATION (48 C2081) --- */
#ifndef _IO_STACK_LOCATION_DEFINED
#define _IO_STACK_LOCATION_DEFINED
struct _IO_STACK_LOCATION;
typedef struct _IO_STACK_LOCATION IO_STACK_LOCATION, *PIO_STACK_LOCATION;
#endif

/* --- SID_AND_ATTRIBUTES / PSID_AND_ATTRIBUTES (40 C2081) --- */
...
typedef SID_AND_ATTRIBUTES SID_AND_ATTRIBUTES_ARRAY[1]; /* ANYSIZE_ARRAY */
#endif

/* --- ACCESS_TOKEN / PACCESS_TOKEN (40 C2081) --- */
/* Note: NT defines PACCESS_TOKEN as PVOID (opaque handle), not struct ptr */
...
/* --- OB_DUMP_CONTROL / POB_DUMP_CONTROL (31 C2081) --- */
#ifndef _OB_DUMP_CONTROL_DEFINED
#define _OB_DUMP_CONTROL_DEFINED
struct _OB_DUMP_CONTROL;
typedef struct _OB_DUMP_CONTROL OB_DUMP_CONTROL, *POB_DUMP_CONTROL;
#endif

/* --- KNONVOLATILE_CONTEXT_POINTERS / PKNONVOLATILE_CONTEXT_POINTERS (30 C2081) --- */
#ifndef _KNONVOLATILE_CONTEXT_POINTERS_DEFINED
#define _KNONVOLATILE_CONTEXT_POINTERS_DEFINED
struct _KNONVOLATILE_CONTEXT_POINTERS;
typedef struct _KNONVOLATILE_CONTEXT_POINTERS KNONVOLATILE_CONTEXT_POINTERS, *PKNONVOLATILE_CONTEXT_POINTERS;
#endif

/* --- LOGICAL (28 C2081) — ULONG alias used in NT kernel --- */
...
/* --- VDM_IO_HANDLER / PVDM_IO_HANDLER (26 C2081) --- */
#ifndef _VDM_IO_HANDLER_DEFINED
#define _VDM_IO_HANDLER_DEFINED
struct _VDM_IO_HANDLER;
typedef struct _VDM_IO_HANDLER VDM_IO_HANDLER, *PVDM_IO_HANDLER;
#endif

/* --- KPCR / PKPCR (26 C2081) --- */
#ifndef _KPCR_DEFINED
#define _KPCR_DEFINED
struct _KPCR;
typedef struct _KPCR KPCR, *PKPCR;
#endif

/* --- DFS_PKT_ENTRY / PDFS_PKT_ENTRY (51 C2081) --- */
#ifndef _DFS_PKT_ENTRY_DEFINED
#define _DFS_PKT_ENTRY_DEFINED
struct _DFS_PKT_ENTRY;
typedef struct _DFS_PKT_ENTRY DFS_PKT_ENTRY, *PDFS_PKT_ENTRY;
#endif

/* --- SEP_LOGON_SESSION_REFERENCES (4 C2011) --- */
#ifndef _SEP_LOGON_SESSION_REFERENCES_DEFINED
#define _SEP_LOGON_SESSION_REFERENCES_DEFINED
struct _SEP_LOGON_SESSION_REFERENCES;
typedef struct _SEP_LOGON_SESSION_REFERENCES SEP_LOGON_SESSION_REFERENCES, *PSEP_LOGON_SESSION_REFERENCES;
#endif

/* --- KDEVICE_QUEUE / KDEVICE_QUEUE_ENTRY (2 C2011 each) --- */
#ifndef _KDEVICE_QUEUE_DEFINED
#define _KDEVICE_QUEUE_DEFINED
...
/* --- UNICODE_PREFIX_TABLE / UNICODE_PREFIX_TABLE_ENTRY (1 C2011 each) --- */
#ifndef _UNICODE_PREFIX_TABLE_DEFINED
#define _UNICODE_PREFIX_TABLE_DEFINED
struct _UNICODE_PREFIX_TABLE;
typedef struct _UNICODE_PREFIX_TABLE UNICODE_PREFIX_TABLE, *PUNICODE_PREFIX_TABLE;
struct _UNICODE_PREFIX_TABLE_ENTRY;
typedef struct _UNICODE_PREFIX_TABLE_ENTRY UNICODE_PREFIX_TABLE_ENTRY, *PUNICODE_PREFIX_TABLE_ENTRY;
#endif

/* --- PREFIX_TABLE_ENTRY (1 C2011) --- */
#ifndef _PREFIX_TABLE_ENTRY_DEFINED
#define _PREFIX_TABLE_ENTRY_DEFINED
struct _PREFIX_TABLE_ENTRY;
typedef struct _PREFIX_TABLE_ENTRY PREFIX_TABLE_ENTRY, *PPREFIX_TABLE_ENTRY;
struct _PREFIX_TABLE;
typedef struct _PREFIX_TABLE PREFIX_TABLE, *PPREFIX_TABLE;
#endif

/* --- SID_IDENTIFIER_AUTHORITY (42 C2065) --- */
...
/* --- MM_MAXIMUM_READ_CLUSTER_SIZE (85 C2065) --- */
#ifndef MM_MAXIMUM_READ_CLUSTER_SIZE

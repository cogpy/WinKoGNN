/*
 * ntsamp.h — NT DDK/SDK Compatibility Header
 *
 ...
 */
#ifndef _NT_COMPAT_NTSAMP_H_H_
#define _NT_COMPAT_NTSAMP_H_H_
...
#ifndef _NTSAMP_H_COMPAT
#define _NTSAMP_H_COMPAT

/* Minimal stub — extend as needed */

#endif /* _NTSAMP_H_COMPAT */
